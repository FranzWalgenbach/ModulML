...
def create_app():
	...
	@app.route('/')
	def root():
		return render_template('index.html', next='start')
	...
	def quiz_start():
		return render_template('quiz_start.html', next='decisiontree')
	...
	def quiz_decisiontree():
		return render_template('quiz_decisiontree.html', next='example')
	...
	@app.route('/results')
	def results():
		return render_template('results.html', next='sensspez')

	@app.route('/parameter')
	def parameter():
		#Initialize cookies
		resp = make_response(render_template('parameter.html'))
	...
	def tuning():
		...
		if train_cookie == None or test_cookie == None:
			resp = make_response(render_template('weather_tuning.html', next='ethics'))
			...
			return render_template('weather_tuning.html', next='ethics')
